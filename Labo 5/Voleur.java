...
public final class Voleur extends Personnage implements Comparable {
   ...
   private int comparaisonSexe = 0;	// Compare les sexes des sorciers/sorcières (femelle = 1, mâle = 2)
   ...
   // Incrémente le nombre de larcins par 1
   ...
   // Affiche la présentation du voleur selon son sexe
